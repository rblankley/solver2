/**
 * @file tilearraylookupvector.h
 * @brief Vector of tile arrays indexed by lookup.
 *
 * @section Copyright
...
#ifndef TILEARRAYLOOKUPVECTOR_H
#define TILEARRAYLOOKUPVECTOR_H
...
/// Vector of tile arrays indexed by lookup.
/**
 * @tparam T  tile type
 */
template <class T>
class tileArrayLookupVector : public tileArrayLookup<T>, private std::vector<std::vector<T*>>
{
    typedef tileArrayLookupVector<T> _Myt;                                  ///< My type.
    typedef tileArrayLookup<T> _Mybase;                                     ///< My base type.

    typedef std::vector<std::vector<T*>> _Myimpl;                           ///< My implementation type.
...
public:
    ...
    /// Constructor.
    tileArrayLookupVector() :
        _Mybase(),
        _Myimpl()
    {
        // resize!
        _Myimpl::resize( lookup_type::MAX_INDICES );
    }
...
private:
    ...
    // not implemented
    tileArrayLookupVector( const _Myt & );
