...
class horizontalBoard : public board<L>
{
    typedef horizontalBoard<L, L0> _Myt;                    ///< My type.
...
public:
     ...
     */
    horizontalBoard( const tile_array_lookup_type *lookups, output_tile_array_lookup_type *outputLookups ) :
        _Mybase( 2, 1, lookups ),
     ...
     */
    horizontalBoard( const _Myt &other ) :
        _Mybase( other ),
...
protected:
    ...
    virtual void complete()
    {
        ...
        t.val.left = t0->val.left;
        t.val.top = (t1->val.top << lookup_type::TOP_EDGE_BITS) | t0->val.top;
        t.val.right = t1->val.right;
        t.val.bottom = (t1->val.bottom << lookup_type::TOP_EDGE_BITS) | t0->val.bottom;
